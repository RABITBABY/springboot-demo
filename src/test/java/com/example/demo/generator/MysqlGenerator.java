...
public class MysqlGenerator {
    //com.aaa.bbb
	private static String baoPath="com.example";//aaa
    private static String packageName="";
    private static String projectName="example";//aaa
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("www2320254303")
                        .setUrl("jdbc:mysql://gz-cdb-jkxfrmj7.sql.tencentcdb.com:62701/test?useUnicode=true&characterEncoding=UTF-8&tinyInt1isBit=false")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
